        ...
        <div className="mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature) => (
            <div key={feature.title}>
              <Card className="glass-card border-white/5 bg-white/[0.02] hover:bg-white/[0.04] h-full rounded-[2.5rem] shadow-3d transition-all duration-300">
                <CardHeader className="p-8">
                  <div className="mb-6 h-14 w-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center transition-all duration-300">
                    {feature.icon}
                  </div>
