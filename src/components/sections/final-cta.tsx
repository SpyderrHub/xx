        ...
        >
          <div className="relative z-10 max-w-4xl mx-auto space-y-12">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Limited Beta Opportunity</p>
            </div>

            <h2 className="text-4xl font-black tracking-tighter text-white sm:text-8xl leading-tight">
              Start Designing <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-orange-400">Your Voice today.</span>
            </h2>
            
            <p className="text-base sm:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed font-medium">
              Join thousands of global creators and developers using QuantisAI Labs for studio-quality synthesis.
            </p>

            <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8">
              <Button asChild size="lg" className="h-16 sm:h-20 rounded-[1.5rem] px-12 text-base sm:text-2xl font-black bg-primary btn-glow shadow-3d">
                <Link href="/sign-up">Create Free Account</Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="h-16 sm:h-20 rounded-[1.5rem] px-12 text-base sm:text-2xl font-bold border-white/10 bg-white/5 backdrop-blur-md hover:bg-white/10 shadow-3d">
            ...
            <p className="text-[10px] font-black uppercase tracking-widest text-white/20 pt-4">No credit card required to start free tier.</p>
          </div>
