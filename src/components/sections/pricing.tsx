...
const plans = [
  ...
  },
  {
    ...
    features: ['300,000 Characters', 'Max 2 Hour Sessions', '20 Daily Pro Generations', 'No Watermarks', 'Email Support'],
    cta: 'Get Started',
    highlight: true,
  },
  {
    ...
    features: ['2,000,000 Characters', 'Unlimited Parallelism', 'Voice Cloning', 'Priority API Support'],
    cta: 'Go Pro Now',
    highlight: false,
  },
];
