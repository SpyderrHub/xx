...
const quickLinks = [
  ...
  { title: 'API Reference', desc: 'Integrate QuantisAI Labs into your own apps.', icon: Code2, href: '/docs/api-reference' },
];
    ...
    <div className="space-y-12">
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="text-xl text-muted-foreground leading-relaxed">
          Welcome to the QuantisAI Labs documentation. Here you'll find comprehensive guides and resources to help you generate high-quality AI speech and manage your audio content.
        </p>
      </motion.div>
