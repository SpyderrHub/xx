            ...
            >
              ...
              <div className="prose prose-invert max-w-none space-y-16">
                <Section id="acceptance" title="1. Acceptance of Terms" icon={ScrollText}>
                  <p>
                    By accessing or using the QuantisAI platform (the "Service"), you agree to be bound by these Terms of Service. If you do not agree to all of these terms, do not use the Service. QuantisAI provides an AI-powered voice synthesis platform designed for batch generation and professional vocal output.
                  </p>
                </Section>
                ...
                <Section id="payments" title="3. Payments, Credits & Subscriptions" icon={Zap}>
                  <p>
                    QuantisAI operates on a character-based credit system. Credits are consumed based on the length of input text synthesized into audio.
                  </p>
                  <ul className="list-disc pl-6 space-y-2">
                ...
                <Section id="ip" title="4. Intellectual Property & Ownership" icon={Scale}>
                  <p>
                    QuantisAI grants you a non-exclusive, worldwide, royalty-free license to use the audio content generated by the Service, subject to your plan type:
                  </p>
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li><strong>Voice Models:</strong> QuantisAI retains ownership of the underlying neural models and voice architecture used to generate the audio.</li>
                  </ul>
                </Section>
              ...
              <div className="pt-12 border-t border-white/5 space-y-8">
                ...
                <p className="text-[10px] text-muted-foreground uppercase font-black tracking-[0.3em]">
                  © {new Date().getFullYear()} QuantisAI Synthesis Systems
                </p>
              </div>
            </motion.div>
          </div>
